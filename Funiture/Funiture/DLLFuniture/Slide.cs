...
namespace DLLFuniture
{
    public class Slide
    {
        ...
        private string strTabs = string.Empty;
        ...
        public bool GetByID(int ImagesID)
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    if (!Convert.IsDBNull(reader["Tabs"])) this.Tabs = Convert.ToString(reader["Tabs"]);
        ...
        public object Add()
        {
            ...
            try
            {
                ...
                objData.AddParameter("@Tabs", this.Tabs);
        ...
        public SlideCollection GetAll()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (!Convert.IsDBNull(reader["Tabs"])) obj.Tabs = Convert.ToString(reader["Tabs"]);
