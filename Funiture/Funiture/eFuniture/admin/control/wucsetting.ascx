<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucsetting.ascx.cs" Inherits="admin_control_wucsetting" %>
...
.popupsettings {width:420px; height:250px; border:1px solid #ccc;background-color:#fff; box-shadow:10px 10px inset;box-shadow:1px 1px 5px #dddddd;z-index:-1;
}
                ...
                <asp:Repeater ID="rptData" runat="server" OnItemDataBound="rptData_ItemDataBound" OnItemCommand="rptData_ItemCommand">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><asp:LinkButton ID="lbtUpdate" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Type") %>' CssClass="picker" CommandName="DoUpdate" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Id") %>'></asp:LinkButton></td>
                            <td><%#Eval("Value") %> </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
