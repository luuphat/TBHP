<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucsys_users.ascx.cs" Inherits="admin_control_wucsys_users" %>
...
.popupsettings {width:4250px; height:250px; border:1px solid #ccc;background-color:#fff; box-shadow:10px 10px inset;box-shadow:1px 1px 5px #dddddd;z-index:-1;
}

    .popupsettings .headersetting {width :97%; border-bottom:1px solid #ddd;padding:10px;height:20px; float:left;}
        .popupsettings .headersetting .settingtitle {
        ...
        .popupsettings .headersetting .btnclose {
            float:right;width:10%;
        }
            .popupsettings .headersetting .btnclose img {border:none;
            }
    .popupsettings .settingcontent {
        ...
        .popupsettings .settingcontent .settingtd {
            width:25%;
        }
        .popupsettings .settingcontent .settingtd1 {
           width:70%;
        }
        ...
        <div class="tableoptions">
            <table  style="width:100%;">
                <tr>
                    ...
                    <td style="float:left;padding-left:50px; padding-bottom:10px; font-size:12px;">
                        Tổng cộng: <asp:Label ID="lblcount" runat="server" ForeColor="Red" ></asp:Label>
                    </td>
                    <td style="float:right;padding-bottom:10px;">
                         &nbsp;
                ...
                <asp:Repeater ID="rptData" runat="server"  OnItemDataBound="rptData_ItemDataBound" OnItemCommand="rptData_ItemCommand">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><asp:LinkButton ID="lbtID" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CssClass="picker" CommandName="DoUpdate" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'></asp:LinkButton></td>
                            <td><asp:LinkButton ID="lbtUpdate" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "UserName") %>' CssClass="picker" CommandName="DoUpdate" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'></asp:LinkButton></td>
                            <td><%#Eval("Passwords") %> </td>
                            <td class="center"><%#Convert.ToDateTime(Eval("InputTime")).ToString("dd/MM/yyyy") %></td>
                            <td> <asp:ImageButton ID="btnDelete" CausesValidation="false" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="Delete" OnClientClick="return confirm('Bạn có chắc muốn xóa?');"
   ...
   <div id="dvmodal" runat="server" />
    <cc1:ModalPopupExtender ID="mdPopup" runat="server" TargetControlID="dvmodal"  CancelControlID="btnCencal" DropShadow="false" RepositionMode="RepositionOnWindowResizeAndScroll"  PopupControlID="ModalPanel" BackgroundCssClass="modalBackground" />
            <asp:Panel ID="ModalPanel" runat="server" CssClass="modalPopup">
               <div class="popupsize">
                   <div class="headersetting"> <div class="settingtitle"> <asp:Label ID="lblHandle" runat="server"></asp:Label> </div></div>
                   <div class="settingcontent">
                       <table style="width:100%;">
                           <tr>
                               <td class="settingtd"> Tên đăng nhập : </td>
                               <td class="settingtd1"> <asp:TextBox ID="txtType" Width="300px" runat="server" ValidationGroup="handle"></asp:TextBox> </td>
                            ...
                            <tr>
                               <td class="settingtd">Mật khẩu : </td>
                               <td class="settingtd1"> <asp:TextBox ID="txtValue" Width="300px" runat="server" ValidationGroup="handle"></asp:TextBox> </td>
