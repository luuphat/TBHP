...
public partial class admin_control_footer : System.Web.UI.UserControl
{
    ...
    private FooterCollection LoadData()
    {
    ...
    private FooterCollection GetSubData(FooterCollection Source, int start, int end)
    {
        int iTotalRecord = Source.Count;
        FooterCollection subSource = new FooterCollection();
        if (Source != null)
        {
    ...
    {
        Response.Redirect("~/admin/footer_add.aspx");
    }
    ...
    protected void rptData_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        {
            //Lấy data
            Footer obj = (Footer)e.Item.DataItem;
            if (obj == null) { return; }
            ////Set x
            ////set image
