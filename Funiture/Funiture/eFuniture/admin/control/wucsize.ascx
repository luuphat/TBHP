<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucsize.ascx.cs" Inherits="admin_control_wucsize" %>
...
.popupsettings {width:450px; height:250px; border:1px solid #ccc;background-color:#fff; box-shadow:10px 10px inset;box-shadow:1px 1px 5px #dddddd;z-index:-1;
}
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table1" class="stdtable stdtablecb">
            ...
            <thead>
                <tr>
                    ...
                    <th class="head1">Chiều rộng</th>  
                      <th class="head0">Chiều dài</th>                                          
                    <th class="head0">#</th>                      
                </tr>
            </thead>
            ...
            <asp:Panel ID="ModalPanel" runat="server" CssClass="modalPopup">
               <div class="popupsettings">
                   ...
                   <div class="settingcontent">
                       <table style="width:100%;">
                           <tr>
                               <td class="settingtd"> Chiều rộng : </td>
                            ...
                            <tr>
                               <td class="settingtd">Chiều dài : </td>
