<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucnews.ascx.cs" Inherits="admin_control_wucnews" %>
                ...
                <asp:Repeater ID="rptData" runat="server"  OnItemDataBound="rptData_ItemDataBound" OnItemCommand="rptData_ItemCommand">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><a href="../admin/news_edit.aspx?nid=<%# Eval("NewsID") %>"> <%#Eval("NewsID") %> </a></td>
                            <td><img height="100" width="120" src='<% = Global.Root %><%#Eval("Image") %> '/>  </td>
                            <td><a href="../admin/news_edit.aspx?nid=<%# Eval("NewsID") %>"><%#Eval("Title") %> </a></td> 
