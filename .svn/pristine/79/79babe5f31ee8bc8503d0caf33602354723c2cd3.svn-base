<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucTypes.ascx.cs" Inherits="Cms_Control_wucTypes" %>
...
<div id="center">
    ...
    <div>
        ...
        <div class="divtableheader">
            <div class="tableheader" > Tên thể loại </div><div class="actived">Kích hoạt</div>
        </div>
         <asp:Repeater ID="rptData" runat="server"  OnItemDataBound="rptData_ItemDataBound" OnItemCommand="rptData_ItemCommand">
             <ItemTemplate>
                 <div class="news">
                     <p class="titlenews"><asp:LinkButton ID="lbtUpdate" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "TypeName") %>' CssClass="picker" CommandName="DoUpdate" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "TypeID") %>'></asp:LinkButton></p>
                     <%--<p class="date">Đưa lên bởi: Anhnh | 25/03 | 19 lượt xem </p>--%>
                     <div class="dvactived"><asp:ImageButton ID="ibtIsActived" runat="server" CommandName="DoSetActive" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "TypeID") %>'/> </div>
                     <div class="divedit">
                         <a href ="#"><div class="editnews"><asp:LinkButton ID="lbtEdit" runat="server" Text="Sửa" CommandName="DoUpdate" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "TypeID") %>'></asp:LinkButton> </div></a> 
                         |  <a href ="#"><div class="deletenews"><asp:LinkButton ID="lbtDeleted" runat="server" Text="Xóa" CommandName="DoDeteled" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "TypeID") %>'></asp:LinkButton> </div></a> 
                     </div>
                 </div>
             </ItemTemplate>
         </asp:Repeater>
               ...
               <div class="popup">
                   ...
                   <div class="content">
                       <table style="width:100%;">
                           <tr>
                               <td class="td"> Tên loại: </td>
                               <td class="td1"> <asp:TextBox ID="txtTypeName" Width="250px" runat="server" ValidationGroup="handle"></asp:TextBox> </td>
                               <td><asp:RequiredFieldValidator ID="rqfTypeName" runat="server" ValidationGroup="handle" Display="Dynamic"   ControlToValidate="txtTypeName" ValidateRequestMode="Enabled"   ForeColor="Red"  ErrorMessage="(*)"></asp:RequiredFieldValidator></td>
                           </tr>
                             <tr>
