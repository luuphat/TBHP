<%@ Page Title="" Language="C#" MasterPageFile="~/admincp/Site.master" AutoEventWireup="true"
    CodeFile="New.aspx.cs" Inherits="admincp_new" %>
            ...
            <Columns>
                <asp:BoundField DataField="Title" HeaderText="Tiêu đề" />
                 <asp:TemplateField HeaderText="Hình ảnh">
                    <ItemTemplate>
                       <img  src="<% = Global.Root %><% =Global.GetConfigKey("ImagesNews") %><%#Eval("Image") %>" width="70" height="70" align="middle" />
                    </ItemTemplate>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <a href="new_edit.aspx?id=<%# Eval("newsid") %>">
