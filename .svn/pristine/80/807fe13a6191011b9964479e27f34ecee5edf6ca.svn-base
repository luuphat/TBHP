...
namespace DLLFuniture
{
    public class News
    {
        ...
        public bool GetByID(int NewsID)
        {
            ...
            try
            {
                if (objData.GetConnection() == null || objData.GetConnection().State == ConnectionState.Closed)
                    objData.Connect();
                objData.CreateNewStoredProcedure("sproc_News_GetByNewsID");
        ...
        public bool SetActived()
        {
            ...
            try
            {
                if (objData.GetConnection() == null || objData.GetConnection().State == ConnectionState.Closed)
                    objData.Connect();
                objData.CreateNewStoredProcedure("sproc_Product_SetActived");
        ...
        public object Add()
        {
            ...
            try
            {
                if (objData.GetConnection() == null || objData.GetConnection().State == ConnectionState.Closed)
                    objData.Connect();
                objData.CreateNewStoredProcedure("sproc_News_Add");
        ...
        public object Update()
        {
            ...
            try
            {
                if (objData.GetConnection() == null || objData.GetConnection().State == ConnectionState.Closed)
                    objData.Connect();
                objData.CreateNewStoredProcedure("sproc_News_Update");
        ...
        public bool Delete(int NewsID)
        {
            ...
            try
            {
                if (objData.GetConnection() == null || objData.GetConnection().State == ConnectionState.Closed)
                    objData.Connect();
                objData.CreateNewStoredProcedure("sproc_News_Delete");
                objData.AddParameter("@NewsID", NewsID);
        ...
        public NewsCollection GetList(string textsearch)
        {
            Data objData;
            if (objDataAccess == null)
                objData = new Data();
            ...
            try
            {
                if (objData.GetConnection() == null || objData.GetConnection().State == ConnectionState.Closed)
                    objData.Connect();
                objData.CreateNewStoredProcedure("sproc_News_Get");
                objData.AddParameter("@Textsearch", textsearch);
                IDataReader reader = objData.ExecStoreToDataReader();
                while (reader.Read())
                {
                    if (col == null) { col = new NewsCollection(); }
                    News obj = new News();
        ...
        public NewsCollection GetListTop()
        {
            Data objData;
            if (objDataAccess == null)
                objData = new Data();
            ...
            try
            {
                if (objData.GetConnection() == null || objData.GetConnection().State == ConnectionState.Closed)
                    objData.Connect();
                objData.CreateNewStoredProcedure("sproc_News_GetlistTop");
                IDataReader reader = objData.ExecStoreToDataReader();
                while (reader.Read())
                {
                    if (col == null) { col = new NewsCollection(); }
    ...
    public class NewsCollection : System.Collections.CollectionBase
    {
        ...
        public void Insert(int index, News value)
        {
            List.Insert(index, value);
        }
        public void Remove(News value)
        {
            List.Remove(value);
        }
        public bool Contains(News value)
        {
            return (List.Contains(value));
        }
        protected override void OnValidate(Object value)
        {
            if (value.GetType() != typeof(News))
