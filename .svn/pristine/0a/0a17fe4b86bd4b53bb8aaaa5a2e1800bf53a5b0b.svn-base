        ...
        <div class="tableoptions">
            <table  style="width:100%;">
                <tr>
                    ...
                    <td style="width:10%;float:right;padding-right:10px; padding-bottom:10px;">
                         &nbsp;
                ...
                &nbsp;
                   ...
                   <td style="margin-right:5px;float:right; padding-bottom:10px;">  <webdiyer:AspNetPager ID="anpPager"   runat="server" PagingButtonSpacing="5px" 
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table1" class="stdtable stdtablecb">
            ...
            <thead>
                <tr>
                    ...
                    <th class="head1">#</th>             
                    <th class="head1">Đăng ảnh slide</th> 
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="center"><%#Convert.ToDateTime(Eval("Date")).ToString("dd/MM/yyyy") %></td>
                             <td class="center"><%#Eval("countviews") %> </td>
