<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wucNews.ascx.cs" Inherits="Cms_Control_wucNews" %>
...
<div id="center">
    <div class="titlecenter">
        ...
        <div class="infocenter"> TIN TỨC  </div>   
    ...
    <div>
        ...
        <div class="divtableheader">
           <div class="actived">Hình ảnh</div> <div class="tableheader">Tiêu đề</div><div class="actived">ngày đăng</div>
        </div>
         <asp:Repeater ID="rptData" runat="server"  OnItemDataBound="rptData_ItemDataBound" OnItemCommand="rptData_ItemCommand">
             <ItemTemplate>
                 <div class="news">
                     ...
                     <div class="dvdate"><%# Convert.ToDateTime(Eval("Date")).ToString("dd/MM/yyyy") %> </div>
                     <div class="divedit">
